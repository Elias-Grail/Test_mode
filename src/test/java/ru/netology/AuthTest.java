...
public class AuthTest {
    ...
    @Test
    @DisplayName("Massage if login with wrong login")
    void massageIfLoginWithWrongLogin(){
        var registeredUser = getRegisteredUser("active");
    ...
    @Test
    @DisplayName("Massage if login with wrong password")
    void massageIfLoginWithWrongPassword(){
        var registeredUser = getRegisteredUser("active");
